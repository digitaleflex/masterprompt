# Script pour créer les issues GitHub pour le projet masterprompt

# Naviguer vers le dépôt
cd C:\Users\cyberbeast\3D Objects\masterprompt

# Vérifier que nous sommes dans le bon dépôt
gh repo view
...
- [ ] Ajouter des badges de statut" --label "documentation,enhancement" --assignee digitaleflex
...
- [ ] Écrire les tests" --label "CLI,enhancement" --assignee digitaleflex
...
- [ ] Créer templates avec différents niveaux de sécurité" --label "templates,enhancement" --assignee digitaleflex
...
- [ ] Créer workflow de validation des dépendances" --label "CI/CD,automation" --assignee digitaleflex
...
- [ ] Créer script de gestion des dépendances" --label "automation,enhancement" --assignee digitaleflex
...
- [ ] Intégrer API de documentation automatique" --label "AI,enhancement" --assignee digitaleflex
...
- [ ] Intégrer vérification de sécurité" --label "AI,enhancement" --assignee digitaleflex
...
- [ ] Documenter le système de plugins" --label "enhancement,architecture" --assignee digitaleflex
...
- [ ] Créer documentation contributeurs" --label "documentation,community" --assignee digitaleflex
